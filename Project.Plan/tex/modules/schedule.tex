...
3 (H)	& 01/18/16	 	& \specialcell{Design specification (All) \\ Refine UI prototype (Angel) \\ Math research (Sarah, Carlo, Sarah) \\ Create and rig snake model (Sarah)}		& 			 \\ \hline
...
5		& 02/01/16	 	& \specialcell{Design Specification due Tuesday \\Create detailed development plan (Carlo, Sarah) \\ Continue development of UI and existing backend functions (All)}	& 			 \\ \hline
