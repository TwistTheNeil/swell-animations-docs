...
\label{sec:ptype2}
The second will continue our work on path drawing and generating curves based on user input. We will extend the first prototype by taking the control points and generating B-splines from them.
